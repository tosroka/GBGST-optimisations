...
class GBufferEncoderNet(nn.Module):
    def __init__(self):
        super(GBufferEncoderNet, self).__init__()
        ...
        self.Conv2d_4a_3x3 = BasicConv2d(128, 128, kernel_size=3)
